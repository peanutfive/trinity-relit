...
**目标**：一条命令验证从 Kensington Gardens 到剪线结局的完整主线未断。**已达成。**
...
- GitHub CI：独立分支的 [Check #35578726470](https://github.com/peanutfive/trinity-relit/actions/runs/35578726470) 已通过（Ubuntu / Node 22，代码提交 `9d5edbc`）。改动见 [PR #1](https://github.com/peanutfive/trinity-relit/pull/1)，待合并发布。
...
| 2 ✅ | 通关测试 + 图测试 + CI | 本地与 GitHub CI 通过；浏览器完整通关；PR #1 待合并 |
...
- [x] 阶段 2：通关测试与 CI — 2026-09-21（16 测试、浏览器 199 回合、六扇门删除实验、GitHub CI 均通过；发现并修复预加载列表与 in/out 解析阻断，PR #1 待合并发布）
- [ ] 阶段 3：存档
- [ ] 阶段 4：提示与日志
- [ ] 阶段 5：版权合规
