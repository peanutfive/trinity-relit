...
export const ITEMS = {
  ...
  axe: {
    ...
    desc: "一把锋利的小斧头。刃口闪着寒光。",
    start: "top_of_arbor",
  },
  icicle: {
    cn: "冰锥", aliases: ["icicle","冰锥","冰柱","冰"],
    desc(s) { return s.hasFlag("icicle_hard") ? "一根坚硬的冰锥，在寒冷中保持着形状。" : "一根正在慢慢融化的冰锥。你得赶快用它。"; },
    start: null,
  },
  lump: {
    cn: "金属块", aliases: ["lump","metal","金属块","磁铁","块"],
    desc: "一块沉重的金属，似乎有强烈的磁性。铁制品会被它吸引。",
    start: "crater",
  },
  garlic: {
    cn: "大蒜", aliases: ["garlic","大蒜","蒜"],
    desc: "一瓣新鲜的大蒜，散发着辛辣的气味。",
    start: "herb_garden",
  },
  thyme: {
  ...
  cage: {
    ...
    desc(s) { return s.hasFlag("cage_has_lemming") ? "笼子里关着一只旅鼠。它不安地四处张望。" : "一个小巧的铁丝鸟笼，门可以打开和关上。"; },
    start: null,
  },
  key_barrow: {
    cn: "骸骨钥匙", aliases: ["skeleton key","key","钥匙","骸骨钥匙","骷髅钥匙"],
    desc: "一把由骨头雕成的钥匙，冰冷而光滑。",
    start: "ossuary",
  },
  coconut: {
