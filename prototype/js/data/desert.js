  ...
  tower_platform: {
    ...
    desc(s) {
      if (s.hasFlag("jeep_departed")) {
        return "You are on the tower platform. The base of the tower is below. The jeep has left to the south; you can go down safely now.\n\n你在塔台上。塔底在下方。吉普车已向南离开；你现在可以安全下塔了。";
      }
  ...
  base_of_tower: {
    ...
    events: [
      ...
      },
      {
        ...
        async act(s, eng) {
          eng.print("You cut the wire. The mysterious voice congratulates you, and says not to be worried about the apparent paradox you've created—the time loop closes; what was done is undone and yet remembered. The next thing you know, you're back at the Palace Gate in Kensington Park where this whole adventure started.\n\n你剪断了电线。神秘的声音祝贺你，并说不要为你造成的明显悖论担心——时间循环闭合；既已发生又被抹去，却仍被记得。下一刻，你已回到肯辛顿公园的宫殿门——这场冒险开始的地方。");
